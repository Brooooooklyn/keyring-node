...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        return require('@napi-rs/keyring-android-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('@napi-rs/keyring-android-arm-eabi')
      } catch (e) {
        loadErrors.push(e)
      }
    } else {
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('@napi-rs/keyring-win32-x64-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('@napi-rs/keyring-win32-ia32-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('@napi-rs/keyring-win32-arm64-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
    } else {
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('@napi-rs/keyring-darwin-x64')
      } catch (e) {
        loadErrors.push(e)
      }
    } else if (process.arch === 'arm64') {
      ...
      try {
        return require('@napi-rs/keyring-darwin-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
    } else {
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('@napi-rs/keyring-freebsd-x64')
      } catch (e) {
        loadErrors.push(e)
      }
    } else if (process.arch === 'arm64') {
      ...
      try {
        return require('@napi-rs/keyring-freebsd-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
    } else {
